...
--text-profit:  var(--green-1); --text-loss:     var(--red-1);
...
--tint-profit:  rgba(56,208,96,0.10);   --tint-loss:    rgba(250,85,71,0.10);
...
```
Types: Normal | OutLinePri | OutLineWhite | GhostPrimary | GhostWhite
       DangerFill | DangerOutline | DangerGhost
Sizes: LG(52px/16px) · MD(40px/14px) [DEFAULT] · SM(32px/13px) · XSM(24px/12px)
Radius: 4px always. Icon-only: border-radius 50%.
Font-weight: 700 · text-transform: uppercase

Normal:       bg primary-1 · text n-7 · hover bg primary-2
...
DangerFill:   bg red-1 · text n-7 · hover bg red-2
...
Right slot: "Available: $500.05" (green-1) or hint (n-3) · Error: label → red-1
```
...
border: default/filled n-4 · hover n-3 · focused primary-1 · error red-1 · disabled n-4 opacity 0.5
...
Focused segment ONLY → border-bottom primary-1 · Error ONLY → red-1
...
SHORT:          bg rgba(250,85,71,0.12)  · text red-1
Status Active:  green tint+border · Paused: orange · Stopped: red
Premium:        gradient-4 text (ONLY for premium-gated UI)
Percentile:     Top 10% → gradient-7 · Top 25% → green-1 · Top 50% → n-2 · Bottom → red-1
...
ERROR:     bg rgba(250,85,71,0.08)   · border rgba(250,85,71,0.2)   · accent red-1
...
Fill: primary-1 (default) · green-1 (safe) · orange-1 (≥70%) · red-1 (≥90%)
...
```
Two segments: [LONG % · green-1] [SHORT % · red-1] · height 4px · no gap · radius 0
Label above: [Label n-3] [Long % Bold green-1] [Short % Bold red-1]
Label below: [Long $ · green-1 · Caption] left | [Short $ · red-1 · Caption] right
```
...
Line 1.5px · green-1 positive · red-1 negative · fill area 15% opacity
```
...
```
Line:        green-1 positive · red-1 negative · fill 15% opacity
...
Bar:         green-1 positive · red-1 negative
...
Product docs  : https://docs.copin.io  ·  App: https://app.copin.io
Design context: resources/design-context.md  (principles, anti-patterns)
Token file    : src/theme/tokens.ts
```

---

*Copin Design System Skill v5.1.0 · March 2026*
